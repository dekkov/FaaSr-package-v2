...
**FaaSr-Local** provides a local execution environment for testing and developing [FaaSr](https://faasr.io) workflows without requiring cloud infrastructure. Test your workflows on your local machine before deploying to the cloud - no credentials, no cloud accounts, no cost.
...
* **Validate workflows** - JSON schema compliance checking and cycle detection

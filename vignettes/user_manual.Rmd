...
To use FaaSr-package-v2, you need to organize your project files as follows:
...
This package will simulate these behaviors using `faasr_data` folder as a bucket in S3 Storage.
